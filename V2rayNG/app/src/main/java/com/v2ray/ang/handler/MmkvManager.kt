...
object MmkvManager {
    ...
    private const val ID_SAMAL_METADATA = "SAMAL_METADATA"
    ...
    private val samalStorage by lazy { MMKV.mmkvWithID(ID_SAMAL_METADATA, MMKV.MULTI_PROCESS_MODE) }
    ...
    fun encodeSamalMetadata(guid: String, message: String, expiry: String) {
        samalStorage.encode("${guid}_msg", message)
        samalStorage.encode("${guid}_exp", expiry)
    }

    fun decodeSamalMessage(guid: String): String {
        return samalStorage.decodeString("${guid}_msg") ?: ""
    }

    fun decodeSamalExpiry(guid: String): String {
        return samalStorage.decodeString("${guid}_exp") ?: ""
    }
