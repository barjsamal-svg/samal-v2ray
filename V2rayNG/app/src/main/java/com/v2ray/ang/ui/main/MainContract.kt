...
data class MainUiState(
    ...
    val samalMessage: String = "",
    val samalExpiry: String = "",
    val samalRights: String = "@libsammal"
)
...
sealed interface MainAction {
    ...
    data class ShareSamal(val guid: String, val expireDate: String, val message: String) : MainAction
