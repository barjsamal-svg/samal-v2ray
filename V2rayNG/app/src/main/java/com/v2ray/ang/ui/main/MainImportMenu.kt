...
internal enum class ServerMenuAction(
    ...
    ShareSamal(R.string.menu_item_export_proxy_app, isShareAction = true, supportsComplexProfiles = false),
    ...
    SelectListDialog(
        ...
        onSelected = { action ->
            ...
            when (action) {
                ...
                ServerMenuAction.ShareSamal -> {
                    // In a real app, show a dialog to input expiry and message
                    // For now, we use a placeholder or prompt
                    onAction(MainAction.ShareSamal(guid, "2027-01-01", "Protected by samal v2ray"))
                }
