...
import com.samal.v2ray.core.CoreConfigManager
import com.samal.v2ray.dto.SubscriptionUpdateResult
import com.samal.v2ray.dto.UrlContentRequest
import com.samal.v2ray.dto.entities.ProfileItem
import com.samal.v2ray.dto.entities.SubscriptionCache
import com.samal.v2ray.dto.entities.SubscriptionItem
import com.samal.v2ray.enums.EConfigType
import com.samal.v2ray.extension.isNotNullEmpty
import com.samal.v2ray.fmt.CustomFmt
import com.samal.v2ray.fmt.Hysteria2Fmt
import com.samal.v2ray.fmt.ShadowsocksFmt
import com.samal.v2ray.fmt.SocksFmt
import com.samal.v2ray.fmt.TrojanFmt
import com.samal.v2ray.fmt.V2rayNFmt
import com.samal.v2ray.fmt.VlessFmt
import com.samal.v2ray.fmt.VmessFmt
import com.samal.v2ray.fmt.WireguardFmt
import com.samal.v2ray.util.HttpUtil
import com.samal.v2ray.util.JsonUtil
import com.samal.v2ray.util.LogUtil
import com.samal.v2ray.util.QRCodeDecoder
...
object AngConfigManager {
    ...
    fun share2Samal(context: Context, guid: String, message: String, expiry: String, isLocked: Boolean): java.io.File? {
        val configUri = shareConfig(guid)
        if (configUri.isEmpty()) return null
        val config = MmkvManager.decodeServerConfig(guid)
        val profileName = config?.remarks ?: "samal_config"
        return com.samal.v2ray.handler.SamalCrypto.exportSamalFile(context, configUri, message, expiry, profileName, isLocked)
    }
