...
object AppConfig {
    ...
    const val ANDROID_PACKAGE_NAME_LIST_URL = "$GITHUB_RAW_URL/@libsammal/androidpackagenamelist/master/proxy.txt"
    const val APP_URL = "$GITHUB_URL/@libsammal/SAMAL V2RAY"
    const val APP_API_URL = "https://api.github.com/repos/@libsammal/SAMAL V2RAY/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/@libsammal/SAMAL V2RAY/master/CR.md"
    const val APP_PROMOTION_URL = "aHR0cHM6Ly85LjIzNDQ1Ni54eXovYWJjLmh0bWw="
    const val TG_CHANNEL_URL = "https://t.me/github_@libsammal"
